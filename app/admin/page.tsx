            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    ...
                    <Link href="/admin/question-bank" className="bg-[#2B4EAA] hover:bg-[#2B4EAA]/80 p-6 rounded-xl border border-white/10 transition-colors block text-center">
                        ...
                        <p className="text-sm text-white/70">View, edit, or remove existing game questions</p>
                    </Link>
                    ...
                    <div className="bg-white/5 p-6 rounded-xl border border-white/10">
                        ...
                        <div className="flex items-center justify-between text-sm mt-4">
                            <span>Status:</span>
                            <span className="px-2 py-1 bg-green-500/20 text-green-300 rounded text-xs">OPEN</span>
                        </div>
                    </div>
                </div>
